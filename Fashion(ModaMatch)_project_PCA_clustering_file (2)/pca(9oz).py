...
# 첫 번째 주성분에 따라 데이터 정렬
sorted_pca_df = pca_df.sort_values(by='PC7', ascending=False)
...
fig, axs = plt.subplots(2, 8, figsize=(80, 40))  # 2행 8열의 서브플롯 생성
...
plt.savefig('./data/pca_9oz/pca_9oz_7.png')  # 이미지 파일로 저장
plt.show()
