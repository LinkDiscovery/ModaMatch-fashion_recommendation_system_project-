...
if __name__ == "__main__":
    img_dir = './vector_img/img_backgroundremove'  # 이미지가 저장된 디렉토리
    output_dir = './vector_img/vectorimg/'  # 벡터 값이 저장될 디렉토리
    ...
    # 예측 결과를 CSV 파일로 저장
    output_csv_path = os.path.join(output_dir, 'predictions(배경제거).csv')
